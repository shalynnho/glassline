...
/**
 * This is the main graphics panel that takes care of layout of the items in factory.
 */
...
public class DisplayPanel extends JLayeredPane {
	 ...
	 * 
	 */
	public final static Integer BG_LAYER = 0, STATIONARY_MACHINERY_LAYER = 1, KIT_LAYER = 2, PART_NORMAL_LAYER = 3,
			KIT_IN_MOVE_LAYER = 4, PART_IN_MOVE_LAYER = 5, KITBOT_LAYER = 6, BIN_LAYER = 1, GANTRY_LAYER = 8,
			PARTBOT_LAYER = 9, CEILING_LAYER = 10, DND_LAYER = 11,
	...
	public void setBackGroundImage() {
		ImageIcon icon = null;
		try {
			icon = new ImageIcon(ImageIO.read(new File("imageicons" + File.separator + "realFactoryBackgroundNew.png")));
		} catch (IOException e) {
			e.printStackTrace();
		}
