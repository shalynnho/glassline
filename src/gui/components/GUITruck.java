...
/**
 * The truck collects glass that has been taken off of the line collecting three glass parts and emptying itself on the fourth
 */
...
public class GUITruck extends GuiComponent {
	...
	/**
	 * Moving the stack of glass to and from the truck to the bin, depending on whether glass is being taken from bin or bin is being refilled
	 */
