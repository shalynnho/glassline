...
/**
 * GUIBreakout is a graphical representation of the breakout component that breaks a partially cut piece of glass out of the excess piece
 */
	...
	private void movePartsIn() {
		if (direction.equals(ConveyorDirections.DOWN)) {
			if (guiPart.getCenterY() < getCenterY())
				...
				animationState = AnimationState./* ANIMATING */IDLE;
				this.transducer.fireEvent(TChannel.BREAKOUT, TEvent.WORKSTATION_LOAD_FINISHED, null);
			}
	...
	public void eventFired(TChannel channel, TEvent event, Object[] args) {
			...
			;
		{
			if (event == TEvent.WORKSTATION_DO_ACTION) {
				animationState = AnimationState./* MOVING */ANIMATING;
			}
