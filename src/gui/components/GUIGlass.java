...
/**
 * GUIPart is a graphical representation of the glass that is to be moved around on the conveyer
 * 
 * @author Anoop Kamboj
 * 
 */
...
public class GUIGlass extends GuiComponent implements Serializable {
	...
	/**
	 * Changes the state of the display of the glass according to what the last operation was
	 */
