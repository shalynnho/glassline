...
/**
 * GUIConveyor is a graphical representation of the conveyer component that transfers glass around the factory
 */
...
public class GUIConveyor extends GuiComponent {
	...
	/**
	 * this boolean is checked to see, if the user has overrided the automatic conveyor movement, whether a moving state change was "lost" to the override
	 */
	 ...
	 * 
	 * @param factoryPanel the FactoryPanel containing this GUIConveyor
	 * @param capacity the max blocks the GUIConveyor can contain
	 * @param direction the direction of the conveyor. Used to choose correct image icon and directions.
	 * @param speed the speed of the conveyor when moving
	 */
	 ...
	 * 
	 * @param guipart the GUIPart to add to this GUIConveyor's first position
	 */
	 ...
	 * 
	 * @param guipart removes the GUIPart residing in the GUIConveyor's first block
	 */
	...
	/**
	 * Invoked when the panel containing this GUIConveyor sets the bounds. Now that the GUIConveyor has a location, the points list is populated, and length and width set accordingly.
	 */
	 ...
	 * 
	 * @param b set moving: true or false
	 */
	...
	/**
	 * Called from the Conveyor Status&Control Panel when the user changes a conveyor's control back to "AUTO". If a moving state change was lost to the override, this method also restores the "lost"
	 * moving state
	 */
	public void cancelMovingOverride() {
		if (movingChangeLostToOverride == true) { // reverse the moving state if a change was lost during the override
