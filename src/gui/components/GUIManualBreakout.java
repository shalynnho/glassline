...
/**
 * Manual version of breakout to be used in non-normative scenarios Will be given a part by GUIBreakout, it moves it to itself, animates and tells agent it's done
 */
