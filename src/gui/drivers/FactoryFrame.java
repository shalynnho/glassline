...
public class FactoryFrame extends JFrame {
	...
	public static final int WINDOW_HEIGHT = 790; // 900;

	/**
	 * The window title
	 */
	public static final String WINDOW_TITLE = "Glass Line - Team #13";

	/**
	 * The default frames per second. The speed slider will start at (the closest value to) this value.
	 */
	public static final int DEFAULT_FRAMES_PER_SECOND = 300;//24;
	...
	public void switchToFactoryPanel() {
		...
		topPanel.add(fPanel, "Factory"); // the factory running panel
		((CardLayout) topPanel.getLayout()).show(topPanel, "Factory"); // ensure top panel is on top
	}
}
